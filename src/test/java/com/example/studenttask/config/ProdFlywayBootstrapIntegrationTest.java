...
class ProdFlywayBootstrapIntegrationTest {
    ...
    static void registerProperties(DynamicPropertyRegistry registry) {
        ...
        registry.add("spring.security.oauth2.client.registration.iserv.redirect-uri",
            () -> "https://services.example.invalid/informatik/login/oauth2/code/iserv");
    }
    ...
    @Test
    void prodProfile_migratesLegacySchemaViaFlywayAndLoadsProdSettings() {
        ...
        assertThat(environment.getProperty("server.servlet.context-path")).isEqualTo("/informatik");
