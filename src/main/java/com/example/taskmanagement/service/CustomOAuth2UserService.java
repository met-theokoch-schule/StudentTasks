...
public class CustomOAuth2UserService extends DefaultOAuth2UserService {
    ...
    public CustomOAuth2UserService(UserRepository userRepository, UserService userService) {
        ...
        System.out.println("===>>> CustomOAuth2UserService CREATED! <<<===");
    }
    ...
    private OAuth2User processOAuth2User(OAuth2User oauth2User) {
        ...
        try {
            ...
            user = userService.createOrUpdateUser(subject, email, name, preferredUsername, givenName, familyName, new ArrayList<>(roleNames), new ArrayList<>(groupNames));
